...
export class ComputerGaleryComponent implements OnInit {
  ...
  loadConsultas(): void {
    this.isLoading = true;
    this.http.get<Consulta[]>('https://expert-zebra-gjw47xjp5jjf975g-8085.app.github.dev/computer-vision/list')
      .subscribe(
        data => {
          this.consultas = data;
  ...
  updateConsulta(): void {
    if (this.selectedConsulta) {
      ...
      this.http.put(`https://expert-zebra-gjw47xjp5jjf975g-8085.app.github.dev/computer-vision/update/${updatedConsulta.id}`, {
  ...
  deleteConsulta(id: number): void {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.http.delete(`https://expert-zebra-gjw47xjp5jjf975g-8085.app.github.dev/computer-vision/delete/${id}`)
          .subscribe(
            () => {
